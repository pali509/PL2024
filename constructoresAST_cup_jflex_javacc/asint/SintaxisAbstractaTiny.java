...
public class SintaxisAbstractaTiny {
    ...
    public Bloque bloq(Decs_opt decsOpt, Ins_opt insOpt) {
        return new Bloque(decsOpt, insOpt);
    }

    public Decs_opt si_decs(LDecs decs) {
    ...
    public Ins_opt si_ins(LIns ins) {
        return new Si_ins(ins);
    }

    public Ins_opt no_ins() {
        return new No_ins();
    }
    ...
    public ParamForm_opt si_pform(LParamForm paramForms) {
        return new Si_pform(paramForms);
    }

    public ParamForm_opt no_pform() {
        return new No_pform();
    }

    public LParamForm muchas_pforms(LParamForm paramForms, ParamForm pForm) {
        return new Muchas_pforms(paramForms, pForm);
    }

    public LParamForm una_pform(ParamForm pForm) {
        return new Una_pform(pForm);
    }

    public ParamForm pform(Tipo t, And_opt a, Id identificador) {
        return new Pform(t, a, identificador);
    }

    public And_opt pform_ref() {
        return new Pform_ref();
    }

    public And_opt pform_no_ref() {
        return new Pform_no_ref();
    }

    public Tipo array(Tipo t, LitEntero litEnt) {
        return new Array(t, litEnt);
    }
