...
public class MensajesError {
    ...
    public MensajesError(String procesamiento){
        hayError = false;
        this.procesamiento = "Errores_" + procesamiento;
    ...
    public void getErrores(){
        ...
        for (int i = 0; i < listaFilas.size(); i++) {
            System.out.println(procesamiento + " fila:" + listaFilas.get(i) + " col:" + listaCols.get(i));
        }
    }
